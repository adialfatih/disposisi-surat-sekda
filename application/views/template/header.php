...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/admin-template.css?v=10'); ?>">
    ...
    <?php if (!empty($active_menu) && $active_menu === 'penomoran_surat'): ?>
        <link rel="stylesheet" href="<?= base_url('assets/css/penomoran-surat.css?v=2'); ?>">
    <?php endif; ?>
    ...
    <?php if (!empty($active_menu) && ($active_menu === 'agenda_surat_masuk' OR $active_menu === 'surat_masuk_v2' OR $active_menu === 'acara' OR $active_menu === 'user_management')): ?>
        <link rel="stylesheet" href="<?= base_url('assets/css/surat-masuk.css?v=5'); ?>">
    <?php endif; ?>
 
    <?php if (!empty($active_menu) && $active_menu === 'agenda_disposisi'): ?>
        <link rel="stylesheet" href="<?= base_url('assets/css/surat-masuk.css?v=5'); ?>">
        <link rel="stylesheet" href="<?= base_url('assets/css/disposisi-surat.css?v=2'); ?>">
    <?php endif; ?>
</head>
<body>
